...
class Project {
    constructor(title, icon, image, patternID, available, music, description) {
        this.title = title;
        this.icon = icon;
        this.image = image;
...
let projects = [
    ...
    new Project("Sonic Heroes", images["Sonic_Heroes"], images["Sonic_Heroes_Wallpaper"], "SonicHeroes", true, trackPaths["Frog_Forest"]),
